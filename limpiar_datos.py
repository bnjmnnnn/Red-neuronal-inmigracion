...
def limpiar_datos(df):
    if df.empty:
        ...
        # Excluir CRECIMIENTO_PIB porque puede ser negativo (recesión económica, nada bueno)
        ...
        if negativos.any():
            ...
            # Convertir todos los valores negativos a su valor absoluto (excepto CRECIMIENTO_PIB, para evitar errores)
